...
namespace ShoppingOnline
{
    public partial class AdminDashboardWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            var result = MessageBox.Show("Bạn có muốn đăng xuất khỏi Admin Panel?", 
        ...
        {
            var result = MessageBox.Show("B?n c� mu?n tho�t Admin Dashboard?", 
                "X�c nh?n tho�t", MessageBoxButton.YesNo, MessageBoxImage.Question);
